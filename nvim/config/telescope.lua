...
vim.keymap.set('n', '<C-t>', builtin.registers, {})
...
vim.keymap.set('n', '<leader>to', require("telescope").extensions.luasnip.luasnip, {})
vim.keymap.set('n', '<leader>ta', require("telescope").extensions.aerial.aerial, {})
