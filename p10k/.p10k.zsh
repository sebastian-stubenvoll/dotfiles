# Generated by Powerlevel10k configuration wizard on 2020-12-20 at 20:49 CET.
...
() {
  ...
  # Show battery in dark grey when it's charging or fully charged.
  typeset -g POWERLEVEL9K_BATTERY_{CHARGING,CHARGED}_FOREGROUND=8
  # Show battery in yellow when it's discharging.
  typeset -g POWERLEVEL9K_BATTERY_DISCONNECTED_FOREGROUND=15
